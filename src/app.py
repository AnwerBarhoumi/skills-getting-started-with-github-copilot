...
activities = {
    ...
    "Music Ensemble": {
        "description": "Collaborate with other musicians and perform",
...
activity_categories = {
    "sports": ["Gym Class", "Basketball Team", "Tennis Club", "Swimming Team"],
    "artistic": ["Art Club", "Drama Club", "Music Ensemble", "Dance Class"],
    "intellectual": ["Chess Club", "Programming Class", "Debate Team", "Science Club"]
}
